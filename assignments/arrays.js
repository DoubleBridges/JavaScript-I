...
function lastCar() {
    ...
    make = inventory[lastCar].car_make;
    model = inventory[lastCar].car_model;
    year = inventory[lastCar].car_year;
...
function earlyModels() {
    ...
    for (let i = 0; i < years.length; i++) {
        ...
        if (year < 2000) {
            ...
            earlyModels.push(year);
        }
    }
    return earlyModels.length;
}

console.log(earlyModels());
